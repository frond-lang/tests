#!/usr/bin/env bash
# Stage 2 切片 3 native 验收(BOOTSTRAP_PLAN 附九):
...
# 语料:tests/fixtures/native_slice3/cases/*.frond(ADT 枚举/带字段/
...
CASES="$ROOT/tests/fixtures/native_slice3/cases"
...
echo "native_slice3: $pass passed, $fail failed"
[ "$fail" -eq 0 ]
